...
2. **Lấy tất cả các giá trị**: Phương thức `AllValues()` trả về tất cả các giá trị từ một bảng tính cụ thể.

3. **Cập nhật giá trị**: Phương thức `UpdateValues()` thêm một hàng mới vào bảng tính với một danh sách giá trị.
